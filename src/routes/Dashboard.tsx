...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const totals = todaysDietEntries.reduce(
      (acc, entry) => {
        return {
    ...
    >
      ...
      >
        {isLoading ? (
          ...
          <div className="flex items-center justify-center h-24 text-gray-500 text-base">
            <div className="text-center">
              <p className="text-lg font-medium text-gray-600 mb-2">
                No Macro Goals Set
              </p>
              <p className="text-sm text-gray-500">
                Set your goals to see progress tracking here.
              </p>
            </div>
          </div>
        )}
