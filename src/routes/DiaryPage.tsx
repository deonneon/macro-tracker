...
const DiaryPage: React.FC = () => {
  ...
  const todaysDietEntries = dailyDiet.filter(
  ...
  return (
    <div className="flex h-dvh max-h-dvh overflow-hidden">
      ...
      <div className="flex-1 flex flex-col px-2 sm:px-4 md:px-6 lg:px-8 py-4 min-w-0">
        ...
        {/* New wrapper for content below header */}
        <div className="flex flex-col flex-grow overflow-hidden min-h-0">
          ...
          <motion.div
            className="mt-4 overflow-hidden flex-shrink-0"
            variants={itemVariants}
          >
          ...
          {!isLoading && !currentGoal && (
            <motion.div
              className="p-3 sm:p-4 bg-white rounded-lg shadow-sm flex-shrink-0"
              variants={itemVariants}
            ...
            >
              <p className="text-sm sm:text-base text-yellow-700">
                You haven't set any macro goals yet. Please go to the{" "}
                <a
                  href="/goals"
                  className="text-blue-600 hover:underline"
                  tabIndex={0}
                  aria-label="Go to Goal Setting page"
                >
                  Goal Setting
                </a>{" "}
                page to set your targets.
              </p>
            </motion.div>
          )}
        </div>{" "}
