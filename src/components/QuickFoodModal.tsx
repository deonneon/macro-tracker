...
const QuickFoodModal: React.FC<QuickFoodModalProps> = ({ isOpen, onClose }) => {
    ...
    const { database, addFoodToDatabase, dailyDiet, setDailyDiet } = dietContext;
    ...
    const handleServingSizeInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        if (isValidNumberOrBlank(e.target.value)) {
    ...
    const fetchAINutritionData = async (foodName: string) => {
        ...
        try {
            ...
            setAIError(error.message || 'Failed to fetch nutrition data.');
        }
        setIsAILoading(false);
    };
    ...
    const handleSubmitNewFood = async () => {
        ...
        try {
            ...
            setDailyDiet([...dailyDiet, { 
                date: currentDate, 
                id: 0, // This will be replaced when the database query completes
                ...newFoodData 
            }]);
                ...
                >
                    <div className="flex justify-between items-center px-6 py-4">
                        <div className="flex items-center">
                            <h3 className="text-lg font-medium text-gray-900">Smart Add Form</h3>
                        </div>
                        <button
                            type="button"
                            onClick={onClose}
                    ...
                    <div className="px-6 py-4">
                        <p className="text-gray-500 text-sm mb-6">Add a food name or detailed food description</p>
                            ...
                            <div className="mt-4 border-t border-gray-300 pt-4">
                                {isAILoading ? (
                                    <div className="flex items-center justify-center py-8">
                                        <span className="text-gray-500 text-sm">Fetching nutrition data...</span>
